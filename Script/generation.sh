...
if [ $USER == "jisseaudamien" ] || [ $USER == "grandinbenjamin" ] || [ $USER == "duhalgouetmelec" ]; then
  ...
  #Dynamic creation of Directory and log and error files
    ...
    chmod +x ./Users/$USER/Desktop/architecture_linux/Script/genTick
    chmod +x ./Users/$USER/Desktop/architecture_linux/Script/genSensorData

    sudo gcc ./Users/$USER/Desktop/architecture_linux/Script/genTick.c -o genTick
    sudo gcc ./Users/$USER/Desktop/architecture_linux/Script/genSensorData.c -o genSensorData
